...
Application.prototype.run = function() {
    ...
    return this._settings.get('alarm_time').then(function(time) {
        if (time) {
        ...
        return this._settings.get('alarm_enabled');
...
Application.prototype._getAlarmStation = function() {
    return this._settings.get('alarm_station').then(function(stationId) {
